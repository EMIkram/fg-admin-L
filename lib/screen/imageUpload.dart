        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              Button(
                onPress: () {
                  if(imagetitle_controller.text.trim()==""||imagedescription_controller.text.trim()==""||_drop_down_value==null||image_file==null
                  ||imagetitle_controller.text.trim()==null||imagedescription_controller.text.trim()==null
                  )
                    {
